...
public class ParseGenerator {
	...
	public static JSONObject generateHookDataJson(MethodHookParam param, MethodApiType type) throws JSONException
	{
		...
		hookData.put("Function", type.toString());
		return hookData;
	}

	public static JSONObject generateHookDataJson1(MethodHookParam param, String type) throws JSONException
	{
		JSONObject hookData= new JSONObject();
		hookData.put("Method",param.method.getDeclaringClass().getName()+"->"+param.method.getName());
		//hookData.put("method", param.method.getName());
	...
	public static JSONArray parseArgs(MethodHookParam param, JSONObject hookJson)
	{
		...
		//		hookData.put("method", param.method.getName());
		int i=0;
		args.put(param.thisObject.toString());
    ...
    public static JSONObject parseArgs1(MethodHookParam param, JSONObject hookJson)
    {
        //ParaName pn=new ParaName();
            ...
            try {
                if(object!=null)
                    if(paraname!=null){
                        ...
                        args.put(paraname.get(i),ParseGenerator.parse(object));
