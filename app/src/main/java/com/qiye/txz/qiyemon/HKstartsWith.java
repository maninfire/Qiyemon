...
public class HKstartsWith extends XC_MethodHook implements HKmethod{
    ...
    public HKstartsWith(String className, String methodName, boolean thisObject,/*MethodApiType*/String type){
