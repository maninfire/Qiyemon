...
public class HKcontains extends XC_MethodHook implements HKmethod{
    ...
    public HKcontains(String className, String methodName, boolean thisObject,/*MethodApiType*/String type){
